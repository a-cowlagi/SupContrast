...
def parse_option():
    ...
    if (opt.method == "SupCon"):
        ...
        opt.wandb_path = './save/SupCon/{}_wandb'.format(opt.dataset)
    elif (opt.method == "SimCLR"):
        opt.model_path = './save/SimCLR/{}_models'.format(opt.dataset)
        opt.wandb_path = './save/SimCLR/{}_wandb'.format(opt.dataset)
...
def main():
    ...
    # wandb
    wandb.init(project=f"contrastive_learning_{opt.method}", dir = opt.wandb_folder)
